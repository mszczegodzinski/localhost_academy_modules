...
function getMyAge(input) {
	...
	const dateInput = getMyAgeDate(input);
	const stringInput = getMyAgeString(input);
	const numberInput = getMyAgeNumber(input);
